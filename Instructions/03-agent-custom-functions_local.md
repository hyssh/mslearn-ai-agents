...
> **Note**: `Pass`, if you konw `Azure AI Foundry project endpoint`, you can skip this step and go to the next step `Develop an agent that uses function tools`
...
1. After you've replaced the placeholder, use the **CTRL+S** command to save your changes.

### Define a custom function

1. Open the following file to edit the code file that has been provided for your function code:
...
1. Save the code file (*CTRL+S*) when you have finished. You can also close the code editor (*CTRL+Q*); though you may want to keep it open in case you need to make any edits to the code you added.
