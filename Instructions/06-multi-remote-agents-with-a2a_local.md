...
1. Enter the following comand to open the project for this lab `lab 06`

    ```
    code .
    ```

1. Edit the configuration file that has been provided:
...
1. Edit the title agent's `server.py` file  
